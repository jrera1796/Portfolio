...
function Extra(){
  ...
  <p>Over the years my interests have ranged, from studying psychology, taking photography, producing digital music, to 3D modeling...the list goes on. What I've noticed is that I gravitate towards things that require attention to detail.</p>
</div>)
}
